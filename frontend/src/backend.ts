...
export class Backend implements backendInterface {
    ...
    async addQuizScore(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addQuizScore(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createOrUpdateProfile(arg0: string, arg1: bigint, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllQuizScores(): Promise<Array<[Principal, Array<QuizScore>]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllQuizScores();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async switchTheme(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.switchTheme(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
